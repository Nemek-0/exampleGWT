...
import ru.nemek.client.service.StockPriceServiceAsync;
...
public class ExampleGWT implements EntryPoint {
  ...
  public void onModuleLoad() {
    ...
    // Добовляем стили к элементам UI
    ...
    // Определяем действия для кнопки и text field
  ...
  private void addStock() {
    ...
    if (stocks.contains(symbol)) {
      Window.alert("Данный 'Symbol' уже есть");
      return;
    }
